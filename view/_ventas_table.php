        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form class="form-group-lg" method="post" action="../controller/insertaVenta.php">
                        <div class="form-group">
                            <label for="inputRut" class="sr-only">Rut</label>
                            <input type="text" id="inputRut" class="form-control" name="rut" placeholder="Rut Cliente" required autofocus>
                        </div>
